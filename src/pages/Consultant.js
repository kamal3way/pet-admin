    ...
    const tabListStyles = {
      ...
      const columns1 = useMemo(
        () => [
          ...
          { accessorKey: "bookingCancelReason", header: "BOOKING CALCLE REASON" },
      ...
      const navigateDetails = (items,personalDetails,serviceType) => {
        console.log("itemsitemsitemsitemsitemsitems", serviceType);
        history.push({
          pathname: "/Consultantdetails",
          state: {items,personalDetails,serviceType}
        });
      };
      ...
      const getVendorDetails = async () => {
        ...
        try {
          const requestBody = {
            ...
            radius: "3000000000",
            serviceId: "66459efbbba1c398c8b80ebd",
            find: {
              serviceType: {
                $elemMatch: {
                  serviceId: "66459efbbba1c398c8b80ebd"
