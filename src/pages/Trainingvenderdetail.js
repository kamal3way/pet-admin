...
export const Trainingvenderdetail = () => {
    ...
    <tbody>
      {service.service.map((svc, svcIndex) => (
        <tr key={svcIndex}>
          ...
          <td>{svc.serviceSaloonCharge}</td>
          <td>{svc.serviceHomeCharge}</td>
          <td>
            <Button
              variant="primary"
...
serviceSaloonHourCharge: selectedService.serviceSaloonCharge,
serviceHomeHourCharge: selectedService.serviceHomeCharge,
}}
...
<Form.Group id="serviceSaloonHourCharge">
<Form.Label>Service Saloon Hour Charge</Form.Label>
<Form.Control
type="number"
...
<Form.Group id="serviceHomeHourCharge">
<Form.Label>Service Home Hour Charge</Form.Label>
<Form.Control
type="number"
